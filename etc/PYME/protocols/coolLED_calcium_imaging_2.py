...
# time in s
pe4000_ON_time = 1.5
integrationTime = 1.9 # integration time for camera
total_time = 600
# in number of frames
...
taskList = [
    ...
    T(frame_to_turnOn_pe4000, scope.pe4000.TurnOn, pe4000_ON_time)
]
...
for f in range(numpy.max([frame_to_turnOn_pe4000, 1]),
    ...
    taskList.append(T(f, scope.pe4000.TurnOn, pe4000_ON_time))

# switch off LED after predefined time
frameNum = f + 1
