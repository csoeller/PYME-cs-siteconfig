...
def ini_splitter(MainFrame,scope):
    ...
    scope.splt = splitter.Splitter(MainFrame, scope, scope.cameras['Zyla'], flipChan = 0, dichroic = 'T710LPXXR',
...
def lasers(scope):
    ...
    scope.l488 = cobaltLaser.CobaltLaserE('l488',portname='COM9',minpower=0.001, maxpower=0.2,scopeState = scope.state)
